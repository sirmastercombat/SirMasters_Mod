...
all-targets : client_hl2 server_hl2 tier1 mathlib vgui_controls 


# Individual projects + dependencies

client_hl2 : tier1 mathlib vgui_controls 
	@echo "Building: client_hl2"
	@+cd game/client && $(MAKE) -f client_linux32_hl2.mak $(CLEANPARAM)

server_hl2 : tier1 mathlib 
	@echo "Building: server_hl2"
	@+cd game/server && $(MAKE) -f server_linux32_hl2.mak $(CLEANPARAM)
...
.PHONY: TAGS showtargets regen showregen clean cleantargets cleanandremove relink client_hl2 server_hl2 tier1 mathlib vgui_controls 
