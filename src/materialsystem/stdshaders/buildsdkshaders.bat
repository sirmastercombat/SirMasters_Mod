...
set GAMEDIR=C:\PROGRA~2\Steam\steamapps\sourcemods\delta36
...
set SDKBINDIR=..\..\..\..\..\..\PROGRA~2\Steam\steamapps\sirmastercombat\sourcesdk\bin\orangebox\bin
...
%BUILD_SHADER% nightvision_30				-game %GAMEDIR% -source %SOURCEDIR%
rem echo.
