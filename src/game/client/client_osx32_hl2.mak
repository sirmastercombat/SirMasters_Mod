...
FORCEINCLUDES= 
ifeq "$(CFG)" "debug"
DEFINES += -DDEBUG -D_DEBUG -DGNUC -DPOSIX -D_OSX -DOSX -D_DARWIN_UNLIMITED_SELECT -DFD_SETSIZE=10240 -DQUICKTIME_VIDEO -DFORCE_QUICKTIME -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DNO_STRING_T -DCLIENT_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DENABLE_CHROMEHTMLWINDOW -DHL2_CLIENT_DLL -DVPCGAMECAPS=VALVE -DPROJECTDIR=/Users/joe/p4/ValveGames/rel/singleplayer/src/game/client -D_DLL_EXT=.dylib -DVPCGAME=valve -D_POSIX=1 
else
DEFINES += -DNDEBUG -DGNUC -DPOSIX -D_OSX -DOSX -D_DARWIN_UNLIMITED_SELECT -DFD_SETSIZE=10240 -DQUICKTIME_VIDEO -DFORCE_QUICKTIME -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DNO_STRING_T -DCLIENT_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DENABLE_CHROMEHTMLWINDOW -DHL2_CLIENT_DLL -DVPCGAMECAPS=VALVE -DPROJECTDIR=/Users/joe/p4/ValveGames/rel/singleplayer/src/game/client -D_DLL_EXT=.dylib -DVPCGAME=valve -D_POSIX=1 
endif
INCLUDEDIRS += ./hl2 ./hl2/elements ../../game/shared/hl2 ./ ../../common ../../public ../../public/tier0 ../../public/tier1 ../../game/client/generated_proto_mod_hl2 ../../thirdparty/protobuf-2.3.0/src ../../vgui2/include ../../vgui2/controls ../../game/shared ./game_controls ../../thirdparty/sixensesdk/include 
CONFTYPE = dll
IMPORTLIBRARY = 
GAMEOUTPUTFILE = ../../../game/mod_hl2/bin/client.dylib
OUTPUTFILE=$(OBJ_DIR)/client.dylib
THIS_MAKEFILE = $(PWD)/client_osx32_hl2.mak
...
$(OBJ_DIR)/achievements_hl2.o : $(PWD)/../../game/shared/hl2/achievements_hl2.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
