...
all-targets : server_episodic client_episodic tier1 vgui_controls mathlib 
...
server_episodic : tier1 mathlib 
	...
	@+cd game/server && $(MAKE) -f server_osx32_episodic.mak $(CLEANPARAM)

client_episodic : tier1 vgui_controls mathlib 
	@echo "Building: client_episodic"
	@+cd game/client && $(MAKE) -f client_osx32_episodic.mak $(CLEANPARAM)
...
.PHONY: TAGS showtargets regen showregen clean cleantargets cleanandremove relink server_episodic client_episodic tier1 vgui_controls mathlib 
